...
vgg19.features[0]=nn.Conv2d(3, 32, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
...
resnet.conv1=nn.Conv2d(3, 32, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
...
class ResUnetPlusPlus(nn.Module):
    def __init__(self, batchsize1,num_cls, channel=3, filters=[32, 64, 128, 256, 512]):
...
if __name__ == '__main__':
    net = ResUnetPlusPlus(batchsize1=2, num_cls=3).cuda()
